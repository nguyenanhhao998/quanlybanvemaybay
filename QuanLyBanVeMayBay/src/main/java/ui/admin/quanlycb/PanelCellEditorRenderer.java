...
class PanelCellEditorRenderer extends AbstractCellEditor implements TableCellRenderer, TableCellEditor {
    ...
    private CellTaskPane renderer = new CellTaskPane();
    private CellTaskPane editor = new CellTaskPane();
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ...
        if (isSelected) {
            editor.setBackground(QuanLyChuyenBayPane.SELCECTED_COLOR);
        } else {
            Color color = row % 2 == 0 ? QuanLyChuyenBayPane.EVEN_COLOR : QuanLyChuyenBayPane.ODD_COLOR;
